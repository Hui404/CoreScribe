 ...
 *  STATIC VARIABLES
 **********************/
//static lv_color_t buf_1[320 * 280] __attribute__((at(0xC00000000 + 1280*320*2 + 10*1024 + 160*4) ));
//static lv_color_t buf_2[320 * 280] __attribute__((at(0xC00000000 + 1280*320*2 + 320*280*2 + 10*1024 + 160*4) ));
/**********************
 *      MACROS
 **********************/
