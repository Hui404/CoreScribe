...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_ACCELERATION (300.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2	//加速度
  ...
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 250 // msec (0-254, 255 keeps steppers enabled) 步进电机空闲锁定时间
  ...
  #define DEFAULT_X_MAX_RATE 3000.0 // mm/min (25 ipm)
  #define DEFAULT_Y_MAX_RATE 3000.0 // mm/min
  ...
  #define DEFAULT_X_ACCELERATION 500.0 // 15*60*60 mm/min^2 = 15 mm/sec^2
  #define DEFAULT_Y_ACCELERATION 500.0 // 15*60*60 mm/min^2 = 15 mm/sec^2
  #define DEFAULT_Z_ACCELERATION 200.0 // 15*60*60 mm/min^2 = 15 mm/sec^2
