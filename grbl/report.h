...
#define STATUS_SETTING_READ_FAIL 7			//EEPROM读取失败。使用默认值。
...
#define STATUS_GCODE_UNDEFINED_FEED_RATE 22			//状态：G代码未定义进给率
...
#define STATUS_GCODE_INVALID_TARGET 33				//状态：G代码目标无效
#define STATUS_GCODE_ARC_RADIUS_ERROR 34			//G代码弧半径错误
